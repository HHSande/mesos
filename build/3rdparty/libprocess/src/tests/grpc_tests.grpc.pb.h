 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::tests::Pong>> PrepareAsyncSend(::grpc::ClientContext* context, const ::tests::Ping& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::tests::Pong>>(PrepareAsyncSendRaw(context, request, cq));
    }
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::tests::Pong>* PrepareAsyncSendRaw(::grpc::ClientContext* context, const ::tests::Ping& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::tests::Pong>> PrepareAsyncSend(::grpc::ClientContext* context, const ::tests::Ping& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::tests::Pong>>(PrepareAsyncSendRaw(context, request, cq));
    }
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::tests::Pong>* PrepareAsyncSendRaw(::grpc::ClientContext* context, const ::tests::Ping& request, ::grpc::CompletionQueue* cq) override;
   ...
   public:
    WithStreamedUnaryMethod_Send() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::tests::Ping, ::tests::Pong>(std::bind(&WithStreamedUnaryMethod_Send<BaseClass>::StreamedSend, this, std::placeholders::_1, std::placeholders::_2)));
    }
