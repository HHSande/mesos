...
: ${MESOS_LAUNCHER_DIR:="/home/hanshenriksande/Master/mesos/build/src"}
...
if test $(uname) = 'Darwin'; then
  : ${MESOS_NATIVE_JAVA_LIBRARY:="/home/hanshenriksande/Master/mesos/build/src/.libs/libmesos-1.10.0.dylib"}
  : ${MESOS_NATIVE_LIBRARY:="/home/hanshenriksande/Master/mesos/build/src/.libs/libmesos-1.10.0.dylib"}
else
  : ${MESOS_NATIVE_JAVA_LIBRARY:="/home/hanshenriksande/Master/mesos/build/src/.libs/libmesos-1.10.0.so"}
  : ${MESOS_NATIVE_LIBRARY:="/home/hanshenriksande/Master/mesos/build/src/.libs/libmesos-1.10.0.so"}
fi
