...
PATH=/home/hanshenriksande/Master/mesos/build/../src/cli:${PATH}

# Add the executables (or rather, their libtool wrappers) from 'src'.
PATH=/home/hanshenriksande/Master/mesos/build/src:${PATH}

export PATH

exec /home/hanshenriksande/Master/mesos/build/src/mesos "${@}"
