...
hashmap<int, std::vector<int> > apCluster()
{
	...
	print(center);
	hashmap<int, std::vector<int> > clusters;
	...
	for(int i=0; i<N; i++) {
		...
		//cout << idxForI +1<< " exemplar for  " << i << "\n";

		
		clusters[idxForI+1].push_back(i+1);
